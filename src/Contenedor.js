...
import { EmpireProjects } from "./EmpireProjects";
...
const empireProyect = [
  ...
  },
  {
    ...
    dangerLevel: 40,
    imgUrl:
      "https://static.wikia.nocookie.net/starwars/images/4/44/SWB_TIE_Defender.png",
    description:
  ...
  },
  {
    ...
    dangerLevel: 70,
    imgUrl:
      "https://static.wikia.nocookie.net/starwars/images/3/39/Cataclysm.jpg",
    description:
  ...
  },
  {
    ...
    dangerLevel: 100,
    imgUrl:
      "https://static.wikia.nocookie.net/starwars/images/7/72/DeathStar1-SWE.png",
    description:
  ...
  },
  {
    ...
    dangerLevel: 90,
    imgUrl:
      "https://static.wikia.nocookie.net/starwars/images/2/24/Zombie_trooper.jpg",
    description:
  ...
  },
  {
    ...
    dangerLevel: 74,
    imgUrl:
      "https://static.wikia.nocookie.net/starwars/images/b/bf/Darktrooperprogram.png",
    description:
      "The dark trooper program[2] was an Imperial Department of Military Research[3] program whose goal was to create[2] a force of soldiers known as Dark Troopers for the Galactic Empire.[2] Although it was originally launched as a way to supply humans with a new armor,[3] the program eventually became focused on creating Imperial battle droids, only for it to end in failure. The failure contributed to the Joint Chiefs becoming disinterested in the use of combat droids, with the notable exception of the KX-series security droid.[2]",
    cost: 200,
  },
  {
    id: "ICP",
...
export const Contenedor = () => {
  ...
  const onSearch = (value) => {
    if (value === "") {
      ...
      const filteredProjects = cards.filter(
        (project) =>
